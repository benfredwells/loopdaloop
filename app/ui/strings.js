...
module.kContourTypeDescriptions[AudioConstants.kFlatContour] = module.kFlat;
module.kContourTypeDescriptions[AudioConstants.kSweepContour] = module.kSweep;
module.kContourTypeDescriptions[AudioConstants.kOscillatingContour] = module.kOscillating;
module.kContourTypeDescriptions[AudioConstants.kADSRContour] = module.kADSR;
module.kContourTypeDescriptions[AudioConstants.kNStageContour] = module.kNStage;
module.kContourTypeDescriptions[AudioConstants.kNStageOscillatingContour] = module.kNStageOscillating;
...
module.kOscillationTypeDescriptions[AudioConstants.kConstantOscillation] = module.kConstant;
module.kOscillationTypeDescriptions[AudioConstants.kFadingOscillation] = module.kFading;
module.kOscillationTypeDescriptions[AudioConstants.kSwellingOscillation] = module.kSwelling;
