...
module.kIntermediateStageBeginValues[1] = module.kStage2EndValue;
module.kIntermediateStageDurations[1] = module.kStage3Duration;
module.kIntermediateStageBeginValues[2] = module.kStage3EndValue;
module.kIntermediateStageDurations[2] = module.kStage4Duration;
module.kIntermediateStageBeginValues[3] = module.kStage4EndValue;
module.kIntermediateStageDurations[3] = module.kStage5Duration;
module.kIntermediateStageBeginValues[4] = module.kStage5EndValue;
